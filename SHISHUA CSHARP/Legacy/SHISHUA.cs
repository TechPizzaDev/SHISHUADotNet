...
namespace SHISHUADotNet {
	...
	/// <para/>
	/// This reimplementation supports supports AVX2, SSE2, and Scalar modes explicitly. This guarantees 1:1 parity
	/// with the behavior of the original library, but is significantly more messy and complex than the agnostic implementation.
	/// It does not support the half-size implementations at this time, nor does it support ARM for lack of Neon
	/// support in C#.
	/// </summary>
	public partial class SHISHUALegacy {
		...
		/// <summary>
		/// Create a new instance of <see cref="SHISHUALegacy"/> using the provided seed.
		/// </summary>
		...
		public SHISHUALegacy(ulong seed0, ulong seed1, ulong seed2, ulong seed3) {
